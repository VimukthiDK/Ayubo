...
namespace Ayubo
{
    public partial class frmHireBooking : Form
    {
        public frmHireBooking()
        {
            InitializeComponent();
        }
        ...
        private void frmHireBooking_Load(object sender, EventArgs e)
        {
        ...
        {
            if (rbtDT.Checked == true )
            {
                dtp3.Enabled = true;
                dtp4.Enabled = true;
                dtp2.Enabled = false;
                dtp1.Enabled = false;
                txtDChages.Enabled = false;
                txtONChages.Enabled = false;
                txtDChages.Text = "0.0";
                txtONChages.Text = "0.0";
            ...
            else
            {
                ...
                dtp2.Enabled = true ;
                dtp1.Enabled = true ;
                txtDChages.Enabled = true ;
                txtONChages.Enabled = true ;
        ...
        private void rbtLT_CheckedChanged(object sender, EventArgs e)
        {
            if (rbtLT .Checked == true)
            {
                dtp3.Enabled = false ;
                dtp4.Enabled = false ;
                dtp2.Enabled = true ;
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    int hireNo;
                    hireNo = 0;
                    hireNo = int.Parse(ds.Tables["ARC"].Rows[ds.Tables["ARC"].Rows.Count - 1].ItemArray[0].ToString());
                    hireNo = hireNo + 1;

                    txtHireNo.Text = hireNo.ToString();

                }
                catch (Exception ex)
                {
                    MessageBox.Show("Hire No Already Exits...!");
                }
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        x = "select * from Hire where PackegeType like '" + (txtSearch.Text).Trim() + "%'";

                    }
                    else if (rbtVType.Checked == true)
                    {
                        x = "select * from Hire where VehicalType like '" + (txtSearch.Text).Trim() + "%'";
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (re == DialogResult.Yes)
                    {
                        ...
                        x = "delete from Hire where HireBookingNumber ='" + (txtHireNo.Text).ToString() + "'";
                        cmd = new SqlCommand(x, con);
                        cmd.ExecuteNonQuery();
        ...
        {
            dgv1.Refresh();
            txtHireNo.Text = dgv1.SelectedRows[0].Cells[0].Value.ToString();
